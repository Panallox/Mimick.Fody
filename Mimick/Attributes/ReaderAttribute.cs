...
{
    /// <summary>
    /// Indicates that the associated method should be invoked concurrently, requiring a read lock when the method is entered.
    /// </summary>
    [CompilationImplements(Interface = typeof(IRequireSynchronization))]
    [CompilationOptions(Scope = AttributeScope.Instanced)]
    [AttributeUsage(AttributeTargets.Method)]
    public sealed class ReaderAttribute : Attribute, IRequireInitialization, IRequireSynchronization, IMethodInterceptor
    {
        #region Properties
